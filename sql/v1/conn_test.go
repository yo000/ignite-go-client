	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				args: []driver.NamedValue{
					...
					{Name: "", Ordinal: 2, Value: "Org 2"},
					{Name: "", Ordinal: 3, Value: tm},
					{Name: "", Ordinal: 4, Value: int64(3)},
					{Name: "", Ordinal: 5, Value: "Org 3"},
					{Name: "", Ordinal: 6, Value: tm},
					{Name: "", Ordinal: 7, Value: int64(4)},
					{Name: "", Ordinal: 8, Value: "Org 4"},
					{Name: "", Ordinal: 9, Value: tm},
				},
			},
			want: &result{ra: 3},
		},
		{
			...
			args: args{
				...
				args: []driver.NamedValue{
					{Name: "", Ordinal: 1, Value: tm},
					{Name: "", Ordinal: 2, Value: int64(1)},
				},
			},
			want: &result{ra: 1},
		},
...
func Test_conn_QueryContext(t *testing.T) {
	...
	_, err = c.ExecContext(context.Background(),
		...
		[]driver.NamedValue{
			...
			{Name: "", Ordinal: 2, Value: "Org 1"},
			{Name: "", Ordinal: 3, Value: tm},
			{Name: "", Ordinal: 4, Value: int64(2)},
			{Name: "", Ordinal: 5, Value: "Org 2"},
			{Name: "", Ordinal: 6, Value: tm},
			{Name: "", Ordinal: 7, Value: int64(3)},
			{Name: "", Ordinal: 8, Value: "Org 3"},
			{Name: "", Ordinal: 9, Value: tm},
			{Name: "", Ordinal: 10, Value: int64(4)},
			{Name: "", Ordinal: 11, Value: "Org 4"},
			{Name: "", Ordinal: 12, Value: tm},
		})
	if err != nil {
